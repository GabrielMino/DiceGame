...
public class Game {
	...
	public Game() {} 
	// this constructor cannot be eliminated because throws an error " No default constructor for entity:  : com.dados.domain.Game; nested exception is com.fasterxml.jackson.databind."
	
	public Game(int dice1, int dice2) throws DiceOutOfRange {
		if (dice1<1 || dice1>6 || dice2<1 || dice2>6) throw new DiceOutOfRange("The dice is out of range or the format is not correct");
		this.dice1 = dice1;
		this.dice2 = dice2;
	}
